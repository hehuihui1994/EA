...
tf.app.flags.DEFINE_string('train_file_path', '../resources/renCECps_multi_class_9.txt', 'training file')
...
class Bi_LSTM_Attention_model(object):
    ...
    def run(self):
        ...
        with tf.name_scope('readData'):
            ...
            tr_x, tr_y, tr_doc_len, te_x, te_y, te_doc_len, ev_x, ev_y, ev_doc_len= load_data(
        ...
        with tf.Session() as sess:
            ...
            For_calibrated_B = np.loadtxt('../resources/For_calibrated_B'+str(self.test_index)+'_share2.txt', delimiter=',')  
