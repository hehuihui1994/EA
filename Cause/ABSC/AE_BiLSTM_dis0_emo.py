...
class AE_BiLSTM_dis0_emo(object):
    ...
    def biLSTM(self,inputs,sequence_length,n_hidden,scope):
        ...
        #AE中直接求隐层的加权平均值
        outputs = self.reduce_mean(outputs, sequence_length)
        return outputs
    ...
    # 自定义求隐层的加权平均值(士梁师兄的模型中也是只用了平均值，丁大神也说直接用平均值)
